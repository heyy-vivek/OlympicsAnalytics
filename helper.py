...
def fetch_medal_tally(df, year, country):
    medal_df = df.drop_duplicates(subset=['Team', 'NOC', 'Games', 'Year', 'City', 'Sport', 'Event'])
    flag = 0
    ...
    if flag == 1:
        ...
        x = temp_df.groupby('Team').sum()[['Gold', 'Silver', 'Bronze']].sort_values('Team', ascending=False).reset_index()
